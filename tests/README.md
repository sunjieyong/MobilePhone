This directory contains various tests for the MobilePhone application.

Tests in `codeception` directory are developed with [Codeception PHP Testing Framework](http://codeception.com/).

After creating the MobilePhone application, follow these steps to prepare for the tests:
...
3. Create `yii2_MobilePhone_tests` database and update it by applying migrations:
